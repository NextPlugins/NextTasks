...
public final class GeneralConfiguration implements ConfigurationInjectable {
    ...
    @ConfigField("bStats.enable")
    private boolean useBStats;

    // messages

    @ConfigField("messages.task-list.header")
    private List<String> taskListHeader;

    @ConfigField("messages.task-list.body")
    private String taskListBody;

    @ConfigField("messages.task-list.footer")
    private List<String> taskListFooter;
